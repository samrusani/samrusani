...
- **Paperclip and Scrapling** — [safe Office attachment MIME handling](https://github.com/paperclipai/paperclip/pull/8562) and [custom Chromium paths for MCP browser tools](https://github.com/D4Vinci/Scrapling/pull/360).
